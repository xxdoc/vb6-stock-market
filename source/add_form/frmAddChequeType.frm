...
Private Sub InitFormLayout()
   ...
   pnlHeader.Caption = "เพิ่มประเภทพิมพ์ ( รายการบัญชี " & AccNo & " และ หมายเลขบัญชี " & AccName & " )"
   
   Call InitNormalLabel(lblChequeType, MapText("ประเภทพิมพ์"), RGB(255, 0, 0))
   Call InitNormalLabel(lblNote, MapText("กรุณาใสประเภทพิมพ์ โดยเลือกจากรายการบัญชี และ หมายเลขบัญชี ของโปรแกรม EXPRESS"))
