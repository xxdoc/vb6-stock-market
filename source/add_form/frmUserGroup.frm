...
Dim OKClick As Boolean
   ...
   frmAddEditUserGroup.HeaderText = MapText("เพิ่มกลุ่มผู้ใช้งาน")
...
Dim OKClick As Boolean
   ...
   frmAddEditUserGroup.HeaderText = MapText("แก้ไขกลุ่มผู้ใช้งาน")
...
Dim fmsTemp As JSFormatStyle
   ...
   Col.Width = 1035
   Col.Caption = MapText("จำนวนผู้ใช้")
...
Private Sub InitFormLayout()
   ...
   Me.Caption = MapText("ข้อมูลกลุ่มผู้ใช้งาน")
